...
//        testedWaterData.setSaltLevel(new BigDecimal("4.5g"));
...
//        assertEquals(testedWaterData.getSaltLevel(), savedWaterData.getSaltLevel());
//    }
//
//    @Test
...
//        extraWaterData.setSaltLevel(new BigDecimal("2.6"));
